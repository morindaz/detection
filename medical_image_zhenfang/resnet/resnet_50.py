...
from load_data import load_data, load_data_balance
...
if __name__ == '__main__':
    ...
    X_train, Y_train, X_valid, Y_valid, Y_img_name = load_data_balance('../train_img/ap_train_1', '../train_img/ap_label.xlsx',
                                                   (img_rows, img_cols), num_classes, train_ratio)
    ...
    with open('result.txt', 'w') as result:
        ...
        for i in range(len(Y_valid_label)):
            if Y_valid_label[i] != predictions_valid_label[i]:
                result.write('image:{0}\t real:{1}\tpredict:{2}\n'.format(Y_img_name[i], Y_valid_label[i], predictions_valid_label[i]))
