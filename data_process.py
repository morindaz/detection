...
class dataProcess(object):
	def __init__(self, out_rows, out_cols, data_path = "./data/train/image", label_path = "./data/train/label", test_path = "./data/test", npy_path = "./npydata", img_type = "jpg"):
	...
	def create_train_data(self):
		...
		for imgname in imgs:
			...
			label = cv2.imread(self.label_path + "/" + midname,0)
