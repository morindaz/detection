...
class myUnet(object):
	...
	def train(self):
		...
		print('Fitting model...')
		model.fit(imgs_train, imgs_mask_train, batch_size=4, epochs=30, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
	...
	def save_img(self):
		...
		for i in range(imgs.shape[0]):
			...
			img.save("./train_results/%d.jpg"%(i))
